...
//TODO: Задание 6:
// Исправить ошибки в коде и оптимизировать его:
...
{
    return preg_replace('/\B(?=(\d{3})+(?!\d))/', // NOTE: \d любая десятичная цифра
                                                                   // NOTE: \B не является границей слова
                                                                   // NOTE: \d любая десятичная цифра
        (usort(
            $item->prices,
